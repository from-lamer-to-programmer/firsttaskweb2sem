...
if !(strlen($name) < 100){
        echo = "Имя содержит слишком много символов, убедитесь что вы все ввели верно<br>";
        exit;
}

if !(strlen($surname) < 100){
        echo = "Фамилия содержит слишком много символов, убедитесь что вы все ввели верно<br>";
        exit;
}

if !(strlen($number) > 10){
        echo = "Номер содержит слишком много символов, убедитесь что вы все ввели верно<br>";
        exit;
}
